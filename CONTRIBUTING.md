...
layout: default
title: "🤝 Contributing"
description: "Guidelines and information for contributing to the HardFOC NTC Thermistor Driver"
nav_order: 5
parent: "🔧 HardFOC NTC Thermistor Driver"
permalink: /CONTRIBUTING/
---

# 🤝 Contributing to HardFOC NTC Thermistor Driver

Thank you for your interest in contributing to the HardFOC NTC Thermistor Driver!
...
### 🎯 **Quick Reference for NTC Thermistor Driver**
...
- **Consistent Naming** - Follow the established naming conventions:
  - Classes: `PascalCase` (e.g., `NtcThermistor`, `NtcConversion`)
  - Public Functions: `PascalCase` (e.g., `ReadTemperatureCelsius`, `Initialize`)
  - Private Functions: `camelCase` (e.g., `checkInitialized`, `convertTemperature`)
  - Member Variables: `snake_case` with trailing underscore (e.g., `adc_interface_`, `ntc_type_`)
  - Constants: `UPPER_SNAKE_CASE` (e.g., `NTC_TYPE_NTCG163JFT103FT1S`, `DEFAULT_BETA_VALUE`)
  - Local Variables: `snake_case` (e.g., `temperature_value`, `adc_reading`)
  - Parameters: `snake_case` (e.g., `ntc_type`, `temperature_celsius`)

### 🏗️ **Architecture Guidelines**

- **Hardware Abstraction** - Use hardware-agnostic ADC interface
...
- **Conversion Methods** - Support both lookup table and mathematical conversion
...
- **Hardware Testing** - Test on actual NTC thermistor hardware with ESP32
...
- **Accuracy Tests** - Validate temperature conversion accuracy
- **Calibration Tests** - Test calibration and offset compensation
...
- **Example Code** - Provide working examples for temperature measurement applications
...
1. **Hardware Information**: NTC thermistor type, ESP32 version, ADC configuration
...
4. **Hardware Configuration**: Connected peripherals, pin assignments, ADC settings
5. **Debugging Information**: Error messages, log output, stack traces
6. **Temperature Range**: Temperature range where the issue occurs
...
1. **Use Case** - Describe the specific temperature measurement use case
